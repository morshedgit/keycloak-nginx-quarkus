...
import com.sam.keycloak.sms2fa.gateway.SmsServiceFactory;
...
public class SmsAuthenticator implements Authenticator {
	...
	public void authenticate(AuthenticationFlowContext context) {
		...
		// If simulation use code '9999':
		Boolean isSimulation = Boolean.parseBoolean(config.getConfig().get(SmsConstants.SIMULATION_MODE));
		String code = isSimulation? "9999" : SecretGenerator.getInstance().randomString(length, SecretGenerator.DIGITS);
